...
$sql = 'SELECT id as id, name as name, address as address,open_time as open_time,close_time as close_time,
              delivery_time as delivery_time,timestamp as timestamp,currency as currency,
              photo as photo,phone  as phone
            FROM restaurant ;';
//  execute query
